...
This is a python API client to interact with `render`_ and facilitate python scripting of `tilespec`<https://github.com/saalfeldlab/render/blob/master/docs/src/site/markdown/data-model.md>_ creation
