...
class StackVersion():
    def __init__(self,cycleNumber=1,cycleStepNumber=1,stackResolutionX=1,
        stackResolutionY=1,stackResolutionZ=1,materializedBoxRootPath=None,
        versionNotes="",createTimestamp=None):
        import time
...
class Layout():
    def __init__(self,sectionId=None,scopeId=None,cameraId=None,imageRow=None,
                 imageCol=None,stageX=None,stageY=None,rotation=None,pixelsize=0.100):
